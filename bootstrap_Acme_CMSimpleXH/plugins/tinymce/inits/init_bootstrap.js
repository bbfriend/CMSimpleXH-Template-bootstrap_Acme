{
    ...
    language : "%LANGUAGE%",
//    language : "ja",
    plugins : "advimage,advlink,autosave,contextmenu,emotions,fullscreen,insertdatetime,lists,media,paste,save,searchreplace,table,wordcount,clear,syntaxhl",
    ...
    */
	...
	theme_advanced_styles : "imgResponsive=img-responsive;imgResponsive+Circle=img-circle img-responsive;imgResponsive+Rounded=img-rounded img-responsive;imgResponsive+Thumbnail=img-thumbnail img-responsive;blockFadeinUP=fadeInUp animated;blockFadeinDown=fadeInDown animated;blockFadeinLeft=fadeInLeft animated;blockFadeinRight=fadeInRight animated;blockBgGray=gray-bg",
    ...
    fullscreen_settings : {
	theme_advanced_buttons1 : "save,|,fullscreen,code,|,formatselect,fontselect,fontsizeselect,styleselect,bold,italic,underline,strikethrough,|,justifyleft,justifycenter,justifyright,justifyfull,|,cut,copy,paste,pastetext,pasteword,|,bullist,numlist,outdent,indent,blockquote,|,clearleft,clearright,clearboth,|,syntaxhl",
